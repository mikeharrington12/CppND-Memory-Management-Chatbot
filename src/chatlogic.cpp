...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    // Create a local ChatBot instance on the stack then use move semantics to pass the ChatBot instance and thus no longer responsible for memory allocation and deallocation.
    ChatBot chatBot("../images/chatbot.png");
    
    // update _chatBot for the chat logic 
    chatBot.SetChatLogicHandle(this);

    // Adding a pointer to the chat logic so answers can be passed onto the GUI
